...
SELECT setval(pg_get_serial_sequence('accounts_user', 'id'), 1, true);

INSERT INTO authorizations_applicatie
VALUES (1, '003aa834-4d24-4335-80aa-9a57555dcbe8', '{objectsapi}', 'ObjectsAPI', true);
INSERT INTO authorizations_applicatie
VALUES (2, '1f5cb913-caa3-433b-851d-9a371a0c93a8', '{valtimo}', 'Valtimo', true);
INSERT INTO authorizations_applicatie
VALUES (3, 'd346a22a-7f6a-48ef-99f2-4439c3f8f17d', '{openzaak}', 'Open Zaak', true);
...
INSERT INTO notifications_notificationsconfig
VALUES (1, 'https://open-notificaties/api/v1/');
SELECT setval(pg_get_serial_sequence('notifications_notificationsconfig', 'id'), 1, true);

INSERT INTO vng_api_common_apicredential
VALUES (1, 'http://openzaak:8000/autorisaties/api/v1/', 'opennotificaties', 'opennotificaties', 'openzaak',
...
VALUES (1, 'objectsapi', '9wu2''''Z`[x(eEk![:.$mBT6&:F!,%)EY74TS.AU+6');
INSERT INTO vng_api_common_jwtsecret
VALUES (2, 'valtimo', 'zZ!xRP&$qTn4A9ETa^ZMKepDm^8egjPz');
INSERT INTO vng_api_common_jwtsecret
VALUES (3, 'openzaak', 'openzaak');
...
INSERT INTO datamodel_kanaal
VALUES (3, 'ed8f505d-6247-4357-bf0e-50e75609d4e8', 'besluiten', '', '{}');
INSERT INTO datamodel_kanaal
VALUES (4, 'f4636227-e02c-4a49-8eaa-1908bb1a1e68', 'autorisaties', '', '{}');
INSERT INTO datamodel_kanaal
VALUES (5, 'e3e3b1bc-8433-41a3-87b7-a08b83156e93', 'zaaktypen', '', '{}');
INSERT INTO datamodel_kanaal
VALUES (6, 'a6fcc591-f9a5-4e44-b789-f8a4a86914b9', 'informatieobjecttypen', '', '{}');
INSERT INTO datamodel_kanaal
VALUES (7, 'bffea38a-3aa2-4212-be7d-a7b1233a7408', 'besluittypen', '', '{}');
SELECT setval(pg_get_serial_sequence('datamodel_kanaal', 'id'), 7, true);
