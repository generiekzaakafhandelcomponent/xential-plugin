...
const xentialPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      callbackSecret: 'Gedeeld geheim voor het controleren van document-callbacks (optioneel)',
      xentialRootMap: 'Xential root map (optioneel)',
    ...
    en: {
      ...
      callbackSecret: 'Shared secret used to verify document callbacks (optional)',
      xentialRootMap: 'Xential root map (optional)',
